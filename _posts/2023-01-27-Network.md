...
가상회선: 회선 교환 방식과 데이터그램 방식의 장점을 결합한 통신 기술. 처음 패킷으로 최적의 경로를 고정하고 경로가 고정하면 그 다음은 패킷으로 나누어 고속으로 전송하는 기술임. EX) <a href="https://ko.wikipedia.org/wiki/%EB%B9%84%EB%8F%99%EA%B8%B0_%EC%A0%84%EC%86%A1_%EB%B0%A9%EC%8B%9D">ATM(Asynchronous Transfer Mode)</a>
