...
<table style = "border: 1.5px solid black">
    <tr>
        <th style = "border: 1px solid black; text-align: center">p</th>
        <th style = "border: 1px solid black; text-align: center">q</th>
        <th style = "border: 1px solid black; text-align: center">p ∧ q</th>
    </tr>
    <tr>
        <td>T</td>
        <td>T</td>
...
<table style = "border: 1.5px solid black">
    <tr>
        <th style = "border: 1px solid black; text-align: center">p</th>
        <th style = "border: 1px solid black; text-align: center">q</th>
        <th style = "border: 1px solid black; text-align: center">p → q<br>조건명제</th>
        <th style = "border: 1px solid black; text-align: center">q → p<br>역</th>
        <th style = "border: 1px solid black; text-align: center">~p → ~q<br>이</th>
        <th style = "border: 1px solid black; text-align: center">~q → ~p<br>≡ p → q<br>대우</th>
    </tr>
    <tr>
        <td>T</td>
        <td>T</td>
...
<table style = "border: 1.5px solid black">
    <tr>
        <th style = "border: 1px solid black; text-align: center">우선순위</th>
        <th style = "border: 1px solid black; text-align: center">연산자</th>
    </tr>
    <tr>
        <td>1</td>
        <td>()</td>
...
<table style = "border: 1.5px solid black">
  <tr>
    <th style = "border: 1px solid black; text-align: center">법칙</th>
    <th style = "border: 1px solid black; text-align: center; colspan: 2">논리적 동치</th>
  </tr>
  <tr>
...
<table style = "border: 1.5px solid black">
    <thread>
        <tr>
            <th style = "border: 1px solid black; text-align: center">전제</th>
            <th style = "border: 1px solid black; text-align: center">결론</th>
            <th style = "border: 1px solid black; text-align: center">전제</th>
        </tr>
    </thread>
    <tbody>
        ...
        <tr>
            <td style = "color: red; text-align: left">T</td>
            <td style = "color: red; text-align: left">T</td>
            <td style = "color: red; text-align: left">T</td>
        </tr>
        <tr>
...
<table style = "border: 1.5px solid black">
    ...
    <tr>
        <td style = "color: red; text-align: left">F</td>
        <td style = "color: red; text-align: left">T</td>
        <td style = "color: red; text-align: left">T</td>
    </tr>
    <tr>
...
<table style = "border: 1.5px solid black">
    <thead>
        <tr>
            <th style = "border: 1px solid black; text-align: center">법칙 이름</th>
            <th style = "border: 1px solid black; text-align: center">추론법칙</th>
            <th style = "border: 1px solid black; text-align: center">항진명제</th>
        </tr>
    </thead>
    <tbody>
        <tr>
