...
오픈 소스 HTTP 웹 서버 프로그램이다
정적인 데이터를 처리하는 웹 서버이다.
<img src = "https://github.com/aliquis-facio/aliquis-facio.github.io/blob/master/_image/2024-10-19-1.png?raw=true" title = "2024 글로벌 웹 서버 시장 점유율"><sup>[16](#footnote_16)</sup>
...
url 구조: `[프로토콜]://[도메인 주소] or [IP 주소]:[포트 번호]/[파일 경로]`
...
### 2.2.2. url과 www.naver.com과는 너무 다르다~  
