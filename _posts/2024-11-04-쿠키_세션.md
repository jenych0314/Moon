...
보안 면에서 쿠키는 클라이언트 로컬에 저장되기 때문에 변질되거나 request에서 스니핑 -> 보안에 취약
세션은 쿠키를 이용해 세션id만 저장하고 그것으로 구분해서 서버에서 처리하기 때문에 비교적 보안성이 좋다.
다만 세션id를 유추할 수 없는 일련의 문구로

# 4. 캐시(Cache)
웹 페이지 요소를 저장하기 위한 임시 저장 파일이다.  
...
# 참조
* [쿠키, 세션, 캐시](https://interconnection.tistory.com/74)
* [쿠키, 세션, 캐시](https://dev-coco.tistory.com/61)
* [쿠키, 세션](https://lgphone.tistory.com/65)
* [쿠키, 세션 ](https://velog.io/@octo__/%EC%BF%A0%ED%82%A4Cookie-%EC%84%B8%EC%85%98Session)
